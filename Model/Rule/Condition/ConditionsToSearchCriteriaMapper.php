...
class ConditionsToSearchCriteriaMapper
{
     ...
     */
    private CombinedFilterGroupFactory $combinedFilterGroupFactory;
     ...
     * @throws InputException
     */
    private function mapConditionToFilterGroup(ConditionInterface $condition): Filter|FilterGroup|null
    {
     ...
     * @throws InputException
     */
    private function mapCombinedConditionToFilterGroup(CombinedCondition $combinedCondition): ?FilterGroup
    {
        $filters = [];
     ...
     * @throws InputException
     */
    private function mapSimpleConditionToFilterGroup(ConditionInterface $productCondition): Filter|FilterGroup
    {
